...
public class EnchantmentAncientDragonLightning extends Enchantment {
    ...
    public static Enchantment getEnchantment() {
        return KaliaStyleEnchantments.ANCIENT_DRAGON_LIGHTNING;
    }
    ...
    public static void onLivingDeath(LivingDeathEvent evt) {
        if (!evt.getEntity().world.isRemote) {
            ...
            if (bonusLevel > 0) {
                if (!VIC_DRAGON_THUNDER.contains(hurter.getUniqueID())) {
                    if (!hurter.isDead) {
                        VIC_DRAGON_THUNDER.add(hurter.getUniqueID());
                ...
                new SynchronizationTask(1800) {
                    ...
                    @Override
                    public void run() {
                        VIC_DRAGON_THUNDER.remove(hurter.getUniqueID());
                    }
    ...
    public boolean canApplyTogether(Enchantment ench) {
        return super.canApplyTogether(ench) &&
                !ench.equals(KaliaStyleEnchantments.FULL_MOON) &&
                !ench.equals(KaliaStyleEnchantments.LIVING_CORPSE) &&
                !ench.equals(KaliaStyleEnchantments.TIME_REVERSAL);
    }
}

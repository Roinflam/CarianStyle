...
public class EnchantmentDragonBreathCorruption extends Enchantment {
    ...
    public static Enchantment getEnchantment() {
        return KaliaStyleEnchantments.DRAGON_BREATH_CORRUPTION;
    }
                ...
                if (attacker.getHeldItemMainhand() != null) {
                    ...
                    if (bonusLevel > 0) {
                        ...
                        for (Entity entity : entities) {
                            ...
                            entityLivingBase.addPotionEffect(new PotionEffect(KaliaStylePotion.SCARLET_CORRUPTION, bonusLevel * 5 * 20, bonusLevel - 1));
                        }
                    }
                }
            }

...
public class EnchantmentScarletLonia extends Enchantment {
    ...
    public static Enchantment getEnchantment() {
        return KaliaStyleEnchantments.SCARLET_LONIA;
    }
                            ...
                            public void run() {
                                ...
                                if (!entities.isEmpty()) {
                                    for (Entity entity : entities) {
                                        ...
                                        entityLivingBase.addPotionEffect(new PotionEffect(KaliaStylePotion.SCARLET_CORRUPTION, finalBonusLevel * 10 * 20, finalBonusLevel - 1));

...
public class EnchantmentEmptyEpilepsyFire extends Enchantment {
    ...
    public static Enchantment getEnchantment() {
        return KaliaStyleEnchantments.EMPTY_EPILEPSY_FIRE;
    }
                ...
                if (bonusLevel > 0) {
                    if (!(attacker instanceof EntityPlayer) || !((EntityPlayer) attacker).isCreative()) {
                        new SynchronizationTask(5, 1) {
                            ...
                            public void run() {
                                ...
                                float damage = (float) (attacker.getMaxHealth() * 0.1 / 60);
                    ...
                    new SynchronizationTask(5, 1) {
                        ...
                        public void run() {
                            ...
                            float damage = (float) (attacker.getMaxHealth() * 0.1 * bonusLevel * 2 / 60);

...
public class EnchantmentCallStar extends Enchantment {
    ...
    public static Enchantment getEnchantment() {
        return KaliaStyleEnchantments.CALL_STAR;
    }
    ...
    public boolean canApplyTogether(Enchantment ench) {
        return super.canApplyTogether(ench) && !ench.equals(KaliaStyleEnchantments.LORETTA_BIG_BOW) && !ench.equals(KaliaStyleEnchantments.LORETTA_TRICK);
    }
}
